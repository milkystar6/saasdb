...
func (c *opDeadMasterServiceClient) HandleDeadMaster(ctx context.Context, in *DeadMasterRequest, opts ...grpc.CallOption) (*DeadMasterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/saasdb.OpDeadMasterService/HandleDeadMaster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OpDeadMasterService_HandleDeadMaster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/saasdb.OpDeadMasterService/HandleDeadMaster",
	}
...
func (c *opNewMasterServiceClient) HandleNewMaster(ctx context.Context, in *NewMasterRequest, opts ...grpc.CallOption) (*NewMasterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/saasdb.OpNewMasterService/HandleNewMaster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OpNewMasterService_HandleNewMaster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/saasdb.OpNewMasterService/HandleNewMaster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
