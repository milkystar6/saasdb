...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		saasdbRouter.InitInstanceRouter(PrivateGroup)
		saasdbRouter.InitHostRouter(PrivateGroup)
		saasdbRouter.InitDomainRouter(PrivateGroup)
		saasdbRouter.InitProjectRouter(PrivateGroup)
		saasdbRouter.InitBackLogRouter(PrivateGroup)
		saasdbRouter.InitShowProcessListRouter(PrivateGroup)
		saasdbRouter.InitHandleVariablesRouter(PrivateGroup)
