<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <!-- </el-table-column> -->
        <!-- <el-table-column align="left" label="各个domain ids" prop="domain_ids" width="120" /> -->
        <el-table-column align="left" label="cluster_name" prop="cluste_name" width="120" />
        <el-table-column align="left" label="项目组ID" prop="proj_id" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateClusterFunc(scope.row)">变更</el-button>
