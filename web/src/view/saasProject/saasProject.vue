<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="projname" prop="projName" width="120" />
        <el-table-column align="left" label="notify_users" prop="notifyUsers" width="120" />
        <el-table-column align="left" label="alarm组id" prop="alarmGroupId" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="notify_users:"  prop="notifyUsers" >
          <el-input v-model="formData.notifyUsers" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="alarm组id:"  prop="alarmGroupId" >
          <el-input v-model.number="formData.alarmGroupId" :clearable="true" placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const updateProjectFunc = async(row) => {
    ...
    type.value = 'update'
    if (res.code === 0) {
        formData.value = res.data.repriject
