<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="domainId" prop="domainId" width="120" />
        <el-table-column align="left" label="insId" prop="insId" width="120" />
        <el-table-column align="left" label="domainName" prop="domainName" width="120" />
        <el-table-column align="left" label="projId" prop="projId" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateDomainFunc(scope.row)">变更</el-button>
